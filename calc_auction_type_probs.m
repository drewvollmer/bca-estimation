...
% Remove neagtive bidder types (from outside option)
...
inv_cdfs = nan( length(bidder_types), NumUAucTypes, length(probabilities) );
...
for bidder_type = bidder_types'
    ...
    prices = data.BidAmount(is_current_bidder_type);
